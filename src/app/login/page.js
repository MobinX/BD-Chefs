...
export default async function Page({ params, query }) {
  ...
  return (
    <div className="flex flex-col items-center space-y-3 justify-center bg-white w-full pt-8 md:pt-20 px-6 md:px-10 pb-14 overflow-y-scroll scrollbar-hide h-full min-h-full min-w-full">
