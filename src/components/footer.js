...
export const Footer = () => {
    return (<><div className="md:flex flex-row hidden  space-x-6 bg-slate-800 w-full p-4">
        ...
        <Link href="/"><Image src="/logo.png" alt="BD Chefs" width={50} height={50} /></Link>
            ...
            <p className="text-white text-bold"> Subscribe to our newslatter to get daily update</p>
            <div className="flex flex-row justify-between p-1 bg-white rounded-full">
        ...
        <div className="flex flex-row justify-between w-3/5 space-x-8 bg-gray-700 px-5 py-2 rounded-2xl">
            ...
            <div className="flex flex-col space-y-1 text-slate-200/85">
                <p className="text-bold text-white mb-2">Get it on</p>
    ...
    </div><hr className="bg-white  hidden md:block w-full" />
        <div className="md:flex  hidden px-4 flex-row justify-between text-xs bg-slate-800 text-white/60">
